...
from the nucleus and gas. At $r\simeq1$pc, radiation flux from the
...
Indeed, near- and mid-infrared observations of nearby AGN are in general
consistent with $r_{{\rm sub}}\propto L^{1/2}$ relation for the dust
sublimation radius. Notice, however that $F_{{\rm loc}}/F_{{\rm ext}}\propto1/r$
...
ways. Our paper builds on two suggestions: 1) it was realized by \citet{CzernyHryniewicz11}(CH11)
who initially suggested that a failed dusty wind from the outer accretion
disc is responsible for the formation of the broad line region seen
