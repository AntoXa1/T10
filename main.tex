...
to this concept the later reigned over the AGN research for nearly forty years.


At $r(\theta)<\rsub(\theta)$, dust sublimation rate exceeds dust formation rate and 
the medium can become a strong line emitter as at higher distances dust suppresses line 
...
Dust sublimation temperature, $\Tsub$ lays in a  narrow $1500-2000$K range, and thus it is not surprising that the above mentioned increase of coupling beyond $\rsub$ provides natural length-scale for an AGN beyond  the inner accretion disk scale such as the inner-most stable orbit radius, $r_{\rm isco}$. 
