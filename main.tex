...
is produced. In the following we reserve $\Mdt$ for global, and $\mdt$ for local 
...
and the efficiency of accretion $\epsilon=0.1$. Similarly, hereafter for scaled quantities we adopt 
...
In general, the mid-plane density is so high that despite the enhanced
...
In this section we describe the details of our model used do derive estimates from previous sections. 
We adopt an
