...
is produced. In the followin we reserve $\Mdt$ for global, and $\mdt$ for local 
accretion rates. It is standard, after assuming an accretion efficiency,
...
and the efficiency of accretion $\epsilon=0.1$. Similiarely, hereafter for scaled quantaties we adopt 
