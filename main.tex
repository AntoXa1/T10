...
\title{A physical model for the convective dusty disk in AGN. Connecting the Torus to the Broad Line Region.}
\begin{abstract}
...
Dust sublimation temperature, $\Tsub$ lays in a 
narrow $1500-2000$K range, and thus it is not surprising that the above mentioned 
increase of coupling beyond $\rsub$ provides natural length-scale for an AGN beyond  
...
radius at $0.4-0.5$pc \citep{Kaspi2000}. 

Magnetic or/and radiation driving have been proposed as a mechanisms behind the formaiton or BLD and the torus.
The line-driven wind (LDW) driven by the UV flux \citep{ProgaKallman2004,Murr05} is an attractive candidate, however it's launching radius
and correspondingly the line widths are a factor $10$ greater than seemingly indicated by the maximum BLR line widths. Similarily AD
launched LDW are not massive enough to be "the torus". Magnetic fields, specifically large-scale magnetic fields 
is clearly an attractive mechanism and models, general enough to explain both BLR and the torus have been suggested. The majority are 
are relying on self-similar solutions \citep{Emmering92,Everett05,Keating12,KoniglKartje94} and thus intrincially
lack any particular spacial scale. Other, are semi-analytical/numerical \citep{Lovelace98,Dorodnitsyn16} show that large-scale B-field 
can supprot AGN torus. At pc scales matter is accreting near the mid-plane, within an accretion
disk that is dense, cold and very geometrically thin: $h/R\propto T^{1/2}\simeq10^{-3}-10^{-4}$. Numerical simulations of thin disks
are still prohibitvely expensive [Stone] confirming previous concerns about the ability of such disks to effectively 
transport large-scale magnetic fields \citep{LubowPapaloizou94,BKLovelace2000,BKLovelace2007}. Preliminary results show that 
quasi-stationary, large-scale magenetically-driven ouflows obtained in a self-consistent numerical simulations of 
thin disk threaded by the net vertical magnetic flux, have difficulties to support enough mass-loading \citep{ZhuStone2018}.
