...
BH}}=10^{7}M_{\odot}$ black hole, dust can exist at  approximately
$0.1$pc compared to 0.5pc outside of the disk.  
...
surface.   The main force that can change the disk vertical structure 
is the disk's own radiation pressure on dust.
Depending on the governing
parameters such as local accretion rate and/or opacity the disk can be strongly 
convective, slim or geometrically thick. Our model incorporates  
